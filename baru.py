...
cl = LINE('Et4P873bBcz84Ci4RM5e./nMb4lYrHfyjvS7txenYVG.hEOd3gM9neh4um4ecwxEn48xNBAACmtgqeOJFzW6t98=')
cl.log("Auth Token : " + str(cl.authToken))

ki = LINE('Et97OUxfHrwiYD1CeQv5.8lIHskUVAYwTJYzVaRsb5q.kQKfm8aOxIt3b9jbP/v3rocNYuHQWteVFxizvh2xNXk=')
ki.log("Auth Token : " + str(ki.authToken))

kk = LINE('EtoXBGbFU2RPiTwOB7j7.dlaGN9/avmQebsRU8SHTTW.P1Slc0w8HV+DwZwfzbJRSVhi4jyO75y49lny7bGxHSM=')
kk.log("Auth Token : " + str(kk.authToken))

kc = LINE('EtSYSThsr4tAduDQnKf6.R8jMT9OA3mKfsK7FMYbprG.Le17D9CSsoWXZ0wIpFiNhYhZYDEfdmwn5T91Tcwxx+s=')
kc.log("Auth Token : " + str(kc.authToken))

cxb = LINE('EsrSyKgxg1AyGJiOmmga.YDTaogO7NhAWBMxiD+ch6G.OXgQUNbk52sLNNHGUEIHaNLEgiDhCj7Mu0lbZyKPR5E=')
cxb.log("Auth Token : " + str(cxb.authToken))

poll = OEPoll(cl)
#call = LineCall(cl)
creator = ["uf8d981e0bc9184560956ced35c4372be"]
owner = ["uf8d981e0bc9184560956ced35c4372be"]
admin = ["uf8d981e0bc9184560956ced35c4372be"]
staff = ["uf8d981e0bc9184560956ced35c4372be"]
...
wait = {
    ...
    "sticker":False,
    "selfbot":True,
    "mention":"jiah dianya ngintip",
    "Respontag":"pa'an tag tag kak:v",
    "welcome":"welcome to",
    "comment":"autolike by.✍T∑∆M❖➣❝SyN_B❂₮❞",
    "message":"thanks for add me\n✍T∑∆M❖➣❝SyN_B❂₮❞\n\Directed by\nRiando\nline.me/ti/p/~bintang_kejora_07\nadd My Creator...",
    }
...
def help():
    ...
    helpMessage = "MAIN SELFBOT\n   KEY " + key + " 」COMMAND\n\n" + \
                  ...
                  "❖⃝➣ " + key + "Key3\n" + \
                  "❖⃝➣ " + key + "Media\n" + \
                  "\n[Python3 Version]✍T∑∆M❖➣❝SyN_B❂₮❞"
    return helpMessage

def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "BLACKLIST「 " + key + " 」COMMAND\n\n" + \
                  "❖⃝➣ " + key + "Restart\n" + \
                  "❖⃝➣ " + key + "Runtime\n" + \
                  "❖⃝➣ " + key + "Blc\n" + \
                  "❖⃝➣ " + key + "Ban:on\n" + \
                  ...
                  "❖⃝➣ " + key + "Join\n" + \
                  "❖⃝➣ " + key + "Back\n" + \
                  "❖⃝➣ " + key + "Leave「Group Name」\n" + \
                  "❖⃝➣ " + key + "Ginfo\n" + \
                  "❖⃝➣ " + key + "Open\n" + \
                  "❖⃝➣ " + key + "Close\n" + \
                  "❖⃝➣ " + key + "Url grup\n" + \
                  "❖⃝➣ " + key + "Gruplist\n" + \
                  "❖⃝➣ " + key + "Infogrup「number」\n" + \
                  "❖⃝➣ " + key + "Infomem「number」\n" + \
                  "❖⃝➣ " + key + "Remove chat\n" + \
                  "❖⃝➣ " + key + "Lurking「on/off」\n" + \
                  "❖⃝➣ " + key + "Lurkers\n" + \
                  "❖⃝➣ " + key + "Sider「on/off」\n" + \
                  "❖⃝➣ " + key + "Updatefoto\n" + \
                  "❖⃝➣ " + key + "Updategrup\n" + \
                  "❖⃝➣ " + key + "Broadcast:「Text」\n" + \
                  "❖⃝➣ " + key + "Setkey「New Key」\n" + \
                  "❖⃝➣ " + key + "Mykey\n" + \
                  "❖⃝➣ " + key + "Resetkey\n" + \
                  "❖⃝➣ " + key + "ID line:「User ID」\n" + \
                  "❖⃝➣ " + key + "Jumlah:「number」\n" + \
                  "❖⃝➣ " + key + "Spamtag「@」\n" + \
                  "❖⃝➣ " + key + "Sticker「on/off」\n" + \
                  "❖⃝➣ " + key + "Respon「on/off」\n" + \
                  "❖⃝➣ " + key + "Contact「on/off」\n" + \
                  "❖⃝➣ " + key + "Autojoin「on/off」\n" + \
                  "❖⃝➣ " + key + "Autoadd「on/off」\n" + \
                  "❖⃝➣ " + key + "Welcome「on/off」\n" + \
                  "❖⃝➣ " + key + "Autoleave「on/off」" + \
                  "❖⃝➣ " + key + "Admin:on\n" + \
                  "❖⃝➣ " + key + "Admin:repeat\n" + \
                  "❖⃝➣ " + key + "Staff:on\n" + \
                  "❖⃝➣ " + key + "Staff:repeat\n" + \
                  ...
                  "❖⃝➣ " + key + "Cek respon \n" + \
                  "❖⃝➣ " + key + "Cek welcome\n" + \
                  "❖⃝➣ " + key + "Set sider:「Text」\n" + \
                  "❖⃝➣ " + key + "Set spam:「Text」\n" + \
                  "❖⃝➣ " + key + "Set pesan:「Text」\n" + \
                  "❖⃝➣ " + key + "Set respon:「Text」\n" + \
                  "❖⃝➣ " + key + "Set welcome:「Text」\n" + \
                  "❖⃝➣ " + key + "Gift:「Mid」「Jumlah」\n" + \
                  "❖⃝➣ " + key + "Spam:「Mid」「Jumlah」\n" + \
                  "\n[Python3 Version]✍T∑∆M❖➣❝SyN_B❂₮❞"
    return helpMessage1
...
def helpbot1():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage3 = "PROTECT\n   GROUP " + key + " 」COMMAND\n\n" + \
                  "❖⃝➣ " + key + "Notag「on/off」\n" + \
                  "❖⃝➣ " + key + "Allprotect「on/off」\n" + \
                  "❖⃝➣ " + key + "Protecturl「on/off」\n" + \
                  "❖⃝➣ " + key + "Protectjoin「on/off」\n" + \
                  "❖⃝➣ " + key + "Protectkick「on/off」\n" + \
                  "❖⃝➣ " + key + "Protectcancel「on/off」" + \
                  "❖⃝➣ " + key + "Listprotect\n\n" + \
                  "\n[Python3 Version]✍T∑∆M❖➣❝SyN_B❂₮❞"
    return helpMessage3
...
def helpbot2():
    ...
    key = key.title()
    helpMessage4 = "MEDIA\n   KEY " + key + " 」COMMAND\n\n" + \
                  "❖⃝➣ " + key + "Sholat:「City Name」\n" + \
                  "❖⃝➣ " + key + "Cuaca:「City Name」\n" + \
                  "❖⃝➣ " + key + "Lokasi:「City Name」\n" + \
                  "❖⃝➣ " + key + "Lirik:「Judul Lagu」\n" + \
                  "❖⃝➣ " + key + "Ytmp3:「Judul Lagu」\n" + \
                  "❖⃝➣ " + key + "Ytmp4:「Judul Video」\n" + \
                  "❖⃝➣ " + key + "Profileig:「Name IG」\n" + \
                  "❖⃝➣ " + key + "Cekdate:「Date month years」\n" + \
                  "\n[Python3 Version]✍T∑∆M❖➣❝SyN_B❂₮❞"
    return helpMessage4
                 ...
                 if wait["Mentionkick"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           cl.sendMessage(msg.to, "pa'an tag sya kak....")
               ...
               if msg.contentType == 13:
                 ...
                 if wait["dellbots"] == True:
                    if msg.contentMetadata["mid"] in Bots:
                        ...
                        wait["dellbots"] = True
                        cl.sendMessage(msg.to,"Contact not listbot CxB")
#ADD STAFF
                 if msg._from in admin:
                 ...
                 if wait["dellstaff"] == True:
                    if msg.contentMetadata["mid"] in staff:
                        ...
                        wait["dellstaff"] = True
                        cl.sendMessage(msg.to,"Contact not staff")
#ADD ADMIN
                 if msg._from in admin:
                 ...
                 if wait["delladmin"] == True:
                    if msg.contentMetadata["mid"] in admin:
                        ...
                        wait["delladmin"] = True
                        cl.sendMessage(msg.to,"Contact not admin")
#ADD BLACKLIST
                 if msg._from in admin:
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "bot on":
                            if msg._from in admin:
                                wait["selfbot"] = True
                                cl.sendText(msg.to, "Bot Ready On")
                                
                        elif cmd == "bot off":
                            if msg._from in admin:
                                wait["selfbot"] = False
                                cl.sendText(msg.to, "Bot Ready off")
                          ...
                          if msg._from in admin:
                            ...
                            for i in group:
                                ...
                                if ginfo == group:
                                    ...
                                    kg.leaveGroup(i)
                                    kh.leaveGroup(i)
                                    cl.sendMessage(msg.to,"Succes leave in group " +str(ginfo.name))
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                ki.sendText(msg.to,"❖➣Send pic.....")
                                
                        elif cmd == "x2up":
                            if msg._from in admin:
                                Setmain["RAfoto"][Bmid] = True
                                kk.sendText(msg.to,"❖➣Send pic.....")
                                
                        elif cmd == "x3up":
                            if msg._from in admin:
                                Setmain["RAfoto"][Cmid] = True
                                kc.sendText(msg.to,"❖➣Send pic.....")
                                
                        elif cmd == "x4up":
                            if msg._from in admin:
                                Setmain["RAfoto"][Zmid] = True
                                sw.sendText(msg.to,"❖➣Send pic.....")
                          ...
                          if msg._from in admin:
                            ...
                            if len(string) <= 10000000000:
                                ...
                                sw.sendMessage(msg.to,"Succes " + string + "")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"✍T∑∆M❖➣❝SyN_B❂₮❞\n\n❖➣Owner:\n"+ma+"\n❖➣Admin:\n"+mb+"\n❖➣Staff:\n"+mc+"\n「%s」SyN_B❂₮ selfbot" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"✍T∑∆M❖➣❝SyN_B❂₮❞ Protection]\n\n❖➣ Protect url:\n"+ma+"\n❖➣ Protect kick:\n"+mb+"\n❖➣ Protect join:\n"+md+"\n❖➣ Protect cancel:\n"+mc+"\n「%s」❖➣List Protect Group]" %(str(len(protectqr)+len(protectkick)+len(protectjoin)+len(protectcancel))))
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                ...
                                for i in gid:
                                    ...
                                    if h == ng:
                                        ki.sendMessage(i, "silahkan hubungi admin or staff ✍T∑∆M❖➣❝SyN_B❂₮❞")
                                        ki.leaveGroup(i)
                                        kk.leaveGroup(i)
                                        kc.leaveGroup(i)
                                        cl.sendMessage(to,"Leave succes " +h)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "❖➣  Respawn Speed]\n\n - ❖➣ Speed Profile\n   %.10f\n - ❖➣ Speed Contact\n   %.10f\n - ❖➣ Speed Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))

                        elif cmd == "login" or cmd == "loginbot":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "❖➣Relogin...")
                               cl.sendMessage(msg.to, "Login Success√")
                               
                        elif cmd == "speed" or cmd == "sp":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "❖➣Check for speed...")
                           ...
                           if msg._from in admin:
                                ...
                                if len(cond) == 1:
                                    ...
                                    if num <= len(data["result"]):
                                        ...
                                        result = requests.get("http://api.ntcorp.us/joox/song_info?sid={}".format(urllib.parse.urlencode(params)))
                                        data = result.text
                                        data = json.loads(data)
                                        if data["result"] != []:
                                            ret_ = "╔══[ Music ]"
...
#===========COMMAND BLACKLIST============#
                            ...
                            if msg._from in admin:
                               ...
                               ki.sendText(msg.to,"prok prok jadi apa?")
