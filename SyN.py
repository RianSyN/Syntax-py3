...
cl = LineClient(authToken='EsptANuiVVmKfqqHsbdf.dCbaonkbrEUPz2Yu8tbOtW.Q9bojDovwUJFWRep8LnrscJ1itnXJr2V1Dk9FQ8DXnU=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='ErS6tzonkZLkF1AOF740.jS8fXQuRSGdr0BhIcOpl4a.hCVo5cVQYAAuhMPIeVzyk8kzeGSHsbuO8REzITa5/yM=')
...
poll = LinePoll(cl)
call = LineCall(cl)
creator = ["u0dc04038d28145eba9676c94f130684f"]
owner = ["u0dc04038d28145eba9676c94f130684f"]
admin = ["uebb6976ce05240ce3d9e0216234868f4"]
staff = ["u0dc04038d28145eba9676c94f130684f"]
...
def helpbot():
    ...
    helpMessage1 = "Command Blacklist do not use「 " + key + " 」for command\n\n" + \
                  ...
                  "❖➣ " + key + "X2name:「Nama」\n" + \
                  "❖➣ " + key + "X3name:「Nama」\n" + \
                  "❖➣ " + key + "X1up「Kirim fotonya」\n" + \
                  "❖➣ " + key + "X2up「Kirim fotonya」\n" + \
                  "❖➣ " + key + "X3up「Kirim fotonya」\n" + \
                  "❖➣ " + key + "Gift:「Mid」「Jumlah」\n" + \
                  "❖➣ " + key + "Spam:「Mid」「Jumlah」\n" + \
                  "\n[Created by]✍T∑∆M❖➣❝SyN_B❂₮❞"
    return helpMessage1
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "Progres Responspeed...")
