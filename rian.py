...
import pytz, datetime, thrift, pafy, time, timeit, random, sys, ast, re, os, json, subprocess, threading, string, codecs, requests, tweepy, ctypes, urllib, wikipedia
from datetime import timedelta, date
from datetime import datetime
from bs4 import BeautifulSoup
import youtube_dl

#cl = LineClient(authToken='EsEsFezM4jRtqqn7A8fb.wbk3z+34dwslttQyByFf2W.C88HnpdNriNNQct2a1DFvgXkBhbP7HQBoppZGbaTISc=')
#cl.log("Auth Token : " + str(cl.authToken))
#channel = LineChannel(cl)
#cl.log("Channel Access Token : " + str(channel.channelAccessToken))

cl = LineClient(authToken='Esv3rxo1zzEqBnfVQSVf.dCbaonkbrEUPz2Yu8tbOtW.DmpAfnTJuUGyi02CvTZUIbs4agFV65Puj7BEBSzDnuY=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='ErmdRgWVPFwvForGpTs9.tuMD37GrT0KShOPFLt6fAq.wSilqR61YBEag0Qdym9jMxcnm6KGp56wQ3EtvL/StyM=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='ErHftTfYYykPI9JqTTQ3.wIUCphX9zE2xb080w3/jmW.xF3Og4EAzPqgnz5Q81jxpAuFvM+yHfc2RcxlDRUnqAo=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='ErEDFWGdt7ALra3y7jif.N9wCaSCUHN6taJJbMNOKdW.vMZGJZIoAtt48eQcv/l2fTvYpc0ESjGBzjwaJFCiDAc=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

cxb = LineClient(authToken='Er8PAuPr76ELgLJvsVZc.LsGBeJvIS38kGceT6UvDla.F1oDBWn2L+GThFAZ1PczUZC6KcYmeEYEaZcRTXpCUIo=')
...
def help():
    ...
    helpMessage = "Selfbot Menu\n   use「 " + key + " 」for command\n\n" + \
                  ...
                  "❖➣ " + key + "Spamcall" + \
                  "\n\nProtection do not use「 " + key + " 」for command\n\n" + \
                  "❖➣ " + key + "Notag「on/off」\n" + \
                  "❖➣ " + key + "Semuapro「on/off」\n" + \
                  ...
                  "\n\nSetting do not use「 " + key + " 」for command\n\n" + \
                  "❖➣ " + key + "Sticker「on/off」\n" + \
                  "❖➣ " + key + "Respon「on/off」\n" + \
                  "❖➣ " + key + "Contact「on/off」\n" + \
                  "❖➣ " + key + "Autojoin「on/off」\n" + \
                  ...
                  "\n\nfor Admin do not use「 " + key + " 」for command\n\n" + \
                  "❖➣ " + key + "Admin:on\n" + \
                  "❖➣ " + key + "Admin:repeat\n" + \
                  "❖➣ " + key + "Staff:on\n" + \
                  "❖➣ " + key + "Staff:repeat\n" + \
                  ...
                  "❖➣ " + key + "Listadmin\n" + \
                  "❖➣ " + key + "Listprotect\n\n" + \
                  "\n[Created by]✍T∑∆M❖➣❝SyN_B❂₮❞"
    return helpMessage

def helpbot():
    key = Setmain["keyCommand"]
    key = key.title()
    helpMessage1 = "Command Blacklist do not use「 " + key + " 」for command\n\n" + \
                  "❖➣ " + key + "Blc\n" + \
                  "❖➣ " + key + "Ban:on\n" + \
                  "❖➣ " + key + "Unban:on\n" + \
                  "❖➣ " + key + "Ban「@」\n" + \
                  ...
                  "❖➣ " + key + "Clearban\n" + \
                  "❖➣ " + key + "Refresh" + \
                  "\n\Selfbot Menu use「 " + key + " 」for command\n\n" + \
                  "❖➣ " + key + "Cek sider\n" + \
                  "❖➣ " + key + "Cek spam\n" + \
                  "❖➣ " + key + "Cek pesan \n" + \
                  "❖➣ " + key + "Cek respon \n" + \
